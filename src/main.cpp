...
class Webots2Robocomp : public RoboComp::Application
{
public:
	Webots2Robocomp (QString prfx, bool startup_check) { prefix = prfx.toStdString(); this->startup_check_flag=startup_check; }
private:
	void initialize();
	std::string prefix;
	TuplePrx tprx;
...
int main(int argc, char* argv[])
{
	...
	::Webots2Robocomp app(prefix, startup_check_flag);
